...
from chunk_counters import np_chunk_counter, vp_chunk_counter, jj_chunk_counter
...
jj_chunk_grammar = "JJ: {<JJ>}"
jj_chunk_parser = RegexpParser(jj_chunk_grammar)


# create a list to hold noun phrase chunked sentences and a list to hold verb phrase chunked sentences here
np_chunked_text = list()
vp_chunked_text = list()
jj_chunked_text = list()
...
for pos_tagged_sentence in pos_tagged_text:
    ...
    jj_chunked_text.append(jj_chunk_parser.parse(pos_tagged_sentence))
...
most_common_jj_chunks = jj_chunk_counter(jj_chunked_text)
print(most_common_jj_chunks)
